...
function Home2() {
  ...
  return (
    <>
      <div className="flex px-5 items-center text-[10px] w-full h-20 bg-blue-100 rounded-md shadow-sm shadow-gray-200">
        <img src="app/assets/pngegg (1).png" className='w-8 h-8' alt="" />
        <div className="text-[20px] ml-3 text-white font-bold">Volcano</div>
      </div>
      <div className="flex flex-wrap justify-around p-10 w-full mt-5 h-96 bg-blue-100 rounded-md shadow-sm shadow-gray-200">
